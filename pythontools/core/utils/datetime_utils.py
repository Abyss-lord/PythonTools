...
from ...date.relativedelta import relativedelta
from ..constants.datetime_constant import Month, Quarter, TimeUnit, Week
from ..constants.pattern_pool import PatternPool
from ..errors import UnsupportedDateType
...
class DatetimeUtil:
    ...
    def utc_now(cls) -> datetime:
        ...
        -------
        datetime
            表示当前 UTC 时间的 datetime 对象
        """
        return datetime.now(pytz.UTC)

    @classmethod
    def utc_date_to_timestamp(cls, date: dt_lib.date) -> int:
        """
        将 UTC 日期转换为时间戳
    ...
    @classmethod
    def utc_datetime_to_timestamp(cls, dt: datetime) -> int:
        """
        将 UTC 时间转换为时间戳
